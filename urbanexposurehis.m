...
% InPath = fullfile('I:\CMIP6\Results\Historical\drywetevent_counts\2000-2015daily');
...
fullfile('I:\CMIP6\Results\Historical\drywetevent_counts',num2str(year));
filename=fullfile('I:\CMIP6\Results\Historical\drywetevent_counts\2000-2015daily\',['drywetevent_counts_' ,num2str(year),'.tif']);
...
urbanarea=zeros(m,n);
outputfiles='I:\CMIP6\Results\urbanarea\';
filename=fullfile('I:\CMIP6\土地利用数据集\历史\landcover1000m\hkl1000\',['MODIS_LANDCOVER' ,num2str(year),'.tif']);
for i=1:length(lat)
