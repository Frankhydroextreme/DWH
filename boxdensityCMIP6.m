...
% Historicalda=imread('I:\CMIP6\Results\exposure\His\Hisexposure.tif');
% R245da=imread('I:\CMIP6\Results\exposure\ssp245\exposure245.tif');
% R585da=imread('I:\CMIP6\Results\exposure\ssp585\exposure585.tif');
...
hold on
%plot (ssp245counts(1:36)-detrend(ssp245counts(1:36)),'linewidth',1.5,'Color',[71 131 159]./255,'linestyle','--')
...
text(1962, 2.3, '(a)', 'FontSize', 22, 'FontName', 'Times New Roman', 'FontWeight', 'bold');
% 设置图例位置
...
set(gca, 'LineWidth', 1.5);
text(1962, 8.5, '(b)', 'FontSize', 22, 'FontName', 'Times New Roman', 'FontWeight', 'bold');
% 设置图例位置
legend('Location', 'Best');
set(h, 'Box', 'off');
...
set(gca, 'LineWidth', 1.5);
text(1962, 14, '(c)', 'FontSize', 22, 'FontName', 'Times New Roman', 'FontWeight', 'bold');
% 设置图例位置
legend('Location', 'Best');
set(h, 'Box', 'off');
...
h=legend([legendHdl2(1),legendHdl1(1),legendHdl3(1)],{'Frequency', 'Duration', 'Intensity'},'FontSize',18,'fontname','Times New Roman');
set(h,'Box','off');
...
Historicalda=imread('E:\中国区域复合极端事件概率\数据\hisdryhotwetclip.tif');
R245da=imread('E:\中国区域复合极端事件概率\数据\dryhotwetclip245.tif');
R585da=imread('E:\中国区域复合极端事件概率\数据\dryhotwetclip585.tif');
Historical=Historicalda(find(Historicalda>0));
R245=R245da(find(R245da>0));
R585=R585da(find(R585da>0));
...
% 背景颜色
hYLabel = ylabel('Population exposure ','FontName','Times New Roman');
...
set(h1,'LineStyle', '-', 'Color', CF(1, :),'LineWidth',2)
set(h2,'LineStyle', '-', 'Color', CF(2, :),'LineWidth',2)
set(h3,'LineStyle', '-', 'Color', CF(3, :),'LineWidth',2)

title('');
grid off;
ylim([0.4, 1.2]);

%xlabel('Population exposure','FontName','Times New Roman');
xlabel('Conditional probability','FontName','Times New Roman');
ylabel('Cumulative probability','FontName','Times New Roman');
...
xlabel('Log frequency','FontName','Times New Roman');
